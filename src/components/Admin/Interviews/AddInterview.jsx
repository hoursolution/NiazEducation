...
// In a real app, these would be part of a Material-UI theme.
const colors = {
...
const CreateInterviewForm = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        const [verificationsRes, interviewsRes, applicationsRes] =
          await Promise.all([
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSnackbarMessage("Interview created successfully!");
      ...
      setSnackbarMessage("Error creating interview. Please try again.");
      setSnackbarSeverity("error");
      setSnackbarOpen(true);
  ...
  const handleContinue = () => {
    ...
    if (hasErrors) {
      setSnackbarMessage(
        "Please fill in all required fields in the current section."
      );
      setSnackbarSeverity("error");
      setSnackbarOpen(true);
      return;
            ...
            <Tabs
              ...
              sx={{
                ...
                "& .MuiTabs-indicator": {
                  ...
                  background: `linear-gradient(45deg, ${colors.primary} 30%, #00bcd4 90%)`, // Gradient indicator
                },
              }}
            >
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    >
                      {applications.length > 0 ? (
                        ...
                        <MenuItem disabled>
                          No applications available for interview
                        </MenuItem>
                      )}
                    </TextField>
                  </Grid>
            ...
            >
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    backgroundColor: "#5a6268", // Darker on hover
              ...
              {activeTab === 2 && (
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      backgroundColor: "#20ace0", // Darker on hover
